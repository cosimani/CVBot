...
/**
 * @brief The Dimension class Esta clase mantiene las dimensiones (columnas y filas) de ese menu a controlar
 */
class Dimension  {
public:
    Dimension( int columnas = 0, int filas = 0 ) : columnas( columnas ), filas( filas )  {  }
    int columnas, filas;
};
