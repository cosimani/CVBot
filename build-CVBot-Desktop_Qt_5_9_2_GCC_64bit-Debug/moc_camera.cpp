...
#include "../CVBot/processor/camera.h"
...
QT_MOC_LITERAL(4, 31, 17), // "posicionDetectada"
QT_MOC_LITERAL(5, 49, 12), // "indexColumna"
QT_MOC_LITERAL(6, 62, 9), // "indexFila"
QT_MOC_LITERAL(7, 72, 18), // "seleccionDetectada"
QT_MOC_LITERAL(8, 91, 17), // "selectionDetected"
QT_MOC_LITERAL(9, 109, 21), // "signal_newCameraFrame"
QT_MOC_LITERAL(10, 131, 8), // "cv::Mat*"
QT_MOC_LITERAL(11, 140, 13), // "cameraTexture"
QT_MOC_LITERAL(12, 154, 22), // "signal_nonFaceDetected"
QT_MOC_LITERAL(13, 177, 29), // "signal_nonFaceDetectedForBack"
QT_MOC_LITERAL(14, 207, 7), // "process"
QT_MOC_LITERAL(15, 215, 9) // "calibrate"
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Camera::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::posicionDetectada)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Camera::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::seleccionDetectada)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void Camera::posicionDetectada(int _t1, int _t2)
{
...
// SIGNAL 2
void Camera::seleccionDetectada(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
